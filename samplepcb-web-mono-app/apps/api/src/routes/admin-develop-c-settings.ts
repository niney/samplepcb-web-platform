...
import { AdminDevelopSettingsResponse, AdminDevelopSettingsUpdate } from '@sp/api-contract/develop-c';
import { getDevelopSettings, updateDevelopSettings } from '../lib/develop-c-settings';
...
export const adminDevelopSettingsRoutes: FastifyPluginCallbackZod = (fastify, _opts, done) => {
  ...
  fastify.get('/develop-c/settings', { schema: { response: { 200: AdminDevelopSettingsResponse } } }, async () => ({
