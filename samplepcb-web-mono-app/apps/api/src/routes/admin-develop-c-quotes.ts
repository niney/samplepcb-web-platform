...
import { customerEmailOf, toQuoteView } from './develop-c-requests';
...
export const adminDevelopQuoteRoutes: FastifyPluginCallbackZod = (fastify, _opts, done) => {
  ...
  fastify.post(
    '/develop-c/milestones/:mid/mark-paid',
