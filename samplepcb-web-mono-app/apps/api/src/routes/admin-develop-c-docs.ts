...
import type { AdminDevelopDocumentResponseType, DevelopDocContentType, DevelopRequestStatusType } from '@sp/api-contract/develop-c';
...
import { DEVELOP_FILE_SERVICE_TYPE, addDevelopEvent, asDevelopStatus, toDevelopAreaCodes } from '../lib/develop-c';
import {
...
import { buildDocumentSentEmail, sendDevelopMail } from '../lib/develop-c-email';
import { uploadToFileServer } from '../lib/file-server';
import { collectMultipart, deleteMarketFile } from '../lib/market';
import { prisma } from '../lib/prisma';
import { customerEmailOf } from './develop-c-requests';
...
export const adminDevelopDocRoutes: FastifyPluginCallbackZod = (fastify, _opts, done) => {
  ...
  fastify.post(
    '/develop-c/requests/:id/documents',
  ...
  fastify.post(
    '/develop-c/documents/:docId/revise',
  ...
  fastify.post(
    '/develop-c/documents/:docId/send',
  ...
  fastify.post('/develop-c/documents/:docId/files', async (request, reply) => {
  ...
  fastify.delete(
    '/develop-c/documents/:docId/files/:fileId',
  ...
  fastify.post(
    '/develop-c/documents/:docId/ai-mail',
