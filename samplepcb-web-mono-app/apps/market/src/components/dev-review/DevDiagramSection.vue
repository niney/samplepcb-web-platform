...
<template>
  <div class="grid gap-4">
    ...
    <p v-else-if="meta.status === 'queued' || meta.status === 'running'" class="flex items-center gap-2 rounded-xl bg-copper-50 px-4 py-3 text-body leading-relaxed text-copper-700">
