...
// AI 사전 검토서 뷰 v4(docs/AI_DEV_REVIEW.md §13·§13.7) — 고객·전문가가 같은 JSON 을 같은 순서로 본다.
// 위저드 미리보기와 프로젝트 상세가 공유한다: 고객 의뢰내용 → 시스템 구성도 → 기술개발 검토 결과 → 개발명세서.
...
// 저장하지 않는 파생값(브리프 행·분야 배지)은 계약의 순수 함수 buildDevReviewView 가 렌더 시 계산한다.
...
<template>
  <div class="grid gap-7">
    ...
    <!-- ② 시스템 구성도 — 별도 산출물(3단계에서 병렬 시작, 비동기 완성) -->
    <section class="grid gap-3">
      <DevDiagramSection
        :diagram="diagramView"
