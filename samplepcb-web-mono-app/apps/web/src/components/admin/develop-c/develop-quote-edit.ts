import { computeDevelopQuoteAmounts, splitDevelopMilestoneAmounts } from '@sp/api-contract/develop-c';
import type {
 ...
 * 서버가 같은 규칙으로 409 KIND_MISMATCH 를 낸다(admin-develop-c-quotes.ts).
 */
