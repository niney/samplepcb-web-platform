...
import type { AdminDevelopRequestDetailType, DevelopQuoteKindType } from '@sp/api-contract/develop-c';
import { useAdminDevelopSettings } from '../../../admin/useAdminDevelopC';
  ...
  <section class="rounded-xl border border-gray-200 bg-white p-4">
    <div class="flex flex-wrap items-center gap-2">
      ...
      <button
        ...
        @click="openNew"
      >
        {{ t('admin.developC.quote.new') }}
      </button>
      <span v-else class="ml-auto text-xs text-gray-400">{{ t('admin.developC.quote.closed') }}</span>
    </div>
