      ...
      <ul class="mt-1 grid gap-1">
        <li v-for="m in quote.milestones" :key="m.milestoneId" class="rounded-md bg-gray-50 px-2 py-1.5 text-xs">
          <div class="flex flex-wrap items-center gap-1.5">
            ...
            <span v-if="isOpened(m)" class="rounded-full bg-blue-100 px-1.5 py-0.5 font-bold text-blue-700">{{ t('admin.develop.quote.opened') }}</span>
          ...
          <div v-if="openingId === m.milestoneId" class="mt-1 grid gap-1 rounded-md border border-blue-300 bg-blue-50 p-2">
            <p class="font-bold text-blue-900">{{ t('admin.develop.quote.openMilestoneConfirm') }}</p>
