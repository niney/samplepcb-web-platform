...
<template>
  <div class="space-y-4">
    <a href="/develop/request" target="_blank" rel="noopener" class="inline-flex rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white">{{ t('admin.prototypeRequest') }}</a>
    <div>
