...
import { BusinessInfoResponse, GerberPricingResponse, apiRoutes } from '@sp/api-contract';
import type { BusinessInfoUpdateType, GerberPricingUpdateType } from '@sp/api-contract';
...
export type SettingsTabKey = 'businessInfo' | 'gerberPricing';
