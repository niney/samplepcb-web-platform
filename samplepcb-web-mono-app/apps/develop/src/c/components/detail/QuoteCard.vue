...
import type { DevelopMilestoneViewType, DevelopQuoteStatusType, DevelopQuoteViewType } from '@sp/api-contract/develop-c';
...
const printPath = computed(() => `/develop/c/requests/${String(props.requestId)}/quotes/${String(q.value.quoteId)}/print`);
