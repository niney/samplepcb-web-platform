...
import type { DevelopDocumentViewType, MarketFileMetaType } from '@sp/api-contract/develop-c';
...
const printPath = computed(
  () => `/develop/c/requests/${String(props.requestId)}/documents/${String(props.doc.documentId)}/print`,
);
</script>
