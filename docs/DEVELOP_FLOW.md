...
| `/develop/request` | **위저드 v2 5스텝(2026-09-08, §7.2.1)** — ① 개발 메뉴(시스템개발 배타 / PCB·기구·앱·서버 복수) ② 의뢰 내용(제목·설명·현재/목표 단계·희망 완료 시기·예산·참고 자료·AI 동의·NDA·시스템개발이면 후속 질문 방식) ③ 세부 질문(시스템개발 3문항 또는 전문가 맡김 / 개별은 분야별 질문·툴·슬롯) ④ 제작 계획(시제품 수량·제작 범위·연간 수량·우선순위·조달·납품 형태) ⑤ 검토·접수(**연락처** + 요약 + 동의) |
