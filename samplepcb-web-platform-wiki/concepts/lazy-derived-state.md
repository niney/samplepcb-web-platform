...
topics_connected: [sp-node-api, sp-market-web, sp-vue-web, parts-engine]
status: active
---
...
## Instances
- **2026-07-19~20** in [sp-node-api](../topics/sp-node-api.md) / [sp-vue-web](../topics/sp-vue-web.md) / [parts-engine](../topics/parts-engine.md): **BOM 견적 enrichStatus 게으른 치유** — buildStatus·enrichStatus 이중 생명주기에서 searching 상태 견적의 GET 이 엔진 잡 상태를 확인해 수렴시킨다. 인메모리 잡 소실도 조회 시점 치유로 흡수([[in-memory-async-jobs]]) — 패턴의 4번째 확장
