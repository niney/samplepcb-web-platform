...
4. Check concepts/ for cross-cutting patterns (코어 비수정 기법, 서버 단일 진실, 수동 동기화 드리프트, 관리=sp-vue/소비=sp-php 브릿지, lazy 파생 상태, 스냅샷 박제+서버 재계산, 인메모리 비동기 잡, 판단 단일 소유권)
...
## Stats
Compiled: 2026-07-27 | Topics: 11 | Sources: 44 | Auto-updates: prompt on stale
