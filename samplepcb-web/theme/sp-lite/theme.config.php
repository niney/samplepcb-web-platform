...
// 사용하지 않는 스킨 설정은 값을 비워두시면 됩니다.
$theme_config = array(
    'set_default_skin'              => true,    // sp-lite: 테마 적용 시 아래 PC 스킨을 기본환경설정에 반영
    'preview_board_skin'            => 'theme/basic', // 테마 미리보기 때 적용될 기본 게시판 스킨
    'preview_mobile_board_skin'     => 'basic', // 모바일 게시판 스킨 (PC 전용 테마 → 코어 유지)
    'cf_member_skin'                => 'theme/basic', // 회원 스킨
    'cf_mobile_member_skin'         => 'basic', // 모바일 회원 스킨 (PC 전용 → 코어)
    'cf_new_skin'                   => 'theme/basic', // 최근게시물 스킨
    'cf_mobile_new_skin'            => 'basic', // 모바일 최근게시물 스킨 (코어)
    'cf_search_skin'                => 'theme/basic', // 검색 스킨
    'cf_mobile_search_skin'         => 'basic', // 모바일 검색 스킨 (코어)
    'cf_connect_skin'               => 'theme/basic', // 접속자 스킨
    'cf_mobile_connect_skin'        => 'basic', // 모바일 접속자 스킨 (코어)
    'cf_faq_skin'                   => 'theme/basic', // FAQ 스킨
    'cf_mobile_faq_skin'            => 'basic', // 모바일 FAQ 스킨 (코어)
    ...
    'qa_skin'                       => 'theme/basic', // 1:1문의 스킨
    'qa_mobile_skin'                => 'basic', // 1:1문의 모바일 스킨 (코어)
    'de_shop_skin'                  => 'theme/basic', // 쇼핑몰 PC 기본스킨
    'de_shop_mobile_skin'           => 'basic', // 쇼핑몰 모바일 기본스킨 (코어)
