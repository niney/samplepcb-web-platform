 ...
 *   · 링크 전부 비움(사용자 결정) — 카드·파트너 표기는 <span>. 피그마와 다르게 둔 것·이상 징후는 docs/FIGMA_PAGES.md
 */
...
// 포트폴리오 카드 — 피그마 트랙 6장. 5·6번은 1920 프레임 밖(마퀴가 돌아야 보인다)이고 태그 없이 파트너 표기 줄이 있는 변형 + 사진 회색 덮개(tint).
$sp_idea_cards = array(
    array('img' => 'pf-mppt.jpg',     'alt' => 'MPPT Optimizer 가 적용된 태양광 패널',  'tag' => 'BLE', 'tone' => 'ble', 'code' => 'NX40',       'title' => 'MPPT Optimizer'),
    array('img' => 'pf-cabinet.jpg',  'alt' => 'Smart Cabinet 산업용 제어반',           'tag' => 'BLE', 'tone' => 'ble', 'code' => 'NX15',       'title' => 'Smart Cabinet'),
    array('img' => 'pf-pdd.jpg',      'alt' => 'Partial Discharge Detector 계측 장비',  'tag' => 'LTE', 'tone' => 'lte', 'code' => 'KSE-91A',    'title' => 'Partial Discharge Detector'),
    array('img' => 'pf-backcare.jpg', 'alt' => 'Back Care Device 지압 매트',            'tag' => 'BLE', 'tone' => 'ble', 'code' => 'NX40',       'title' => 'Back Care Device'),
    array('img' => 'pf-forklift.jpg', 'alt' => '지게차 포크 높이 감지 센서가 달린 지게차', 'tag' => '',    'tone' => '',    'code' => 'BLE - NX15', 'title' => 'Forklift Fork Height Detection Sensor', 'partner' => 'UNITOP →', 'tint' => '.2'),
    array('img' => 'pf-rooftop.jpg',  'alt' => '루프탑 텐트를 얹은 차량',                'tag' => '',    'tone' => '',    'code' => 'NX40',       'title' => 'Rooftop Tent Perimeter Detection Radar', 'partner' => 'TEDS→',    'tint' => '.3'),
);
    ...
    <div class="sp-idea__pf">
        ...
        <div class="sp-idea__pf-viewport" id="sp-portfolio" role="region" aria-label="개발 포트폴리오">
            ...
            <?php foreach ($sp_idea_cards as $sp_c) { ?>
                <article class="sp-idea__card<?php echo empty($sp_c['tag']) ? ' sp-idea__card--partner' : ''; ?>">
                    ...
                    <div class="sp-idea__card-body">
                        ...
                        <?php if (!empty($sp_c['partner'])) { ?><span class="sp-idea__card-partner"><?php echo $sp_c['partner']; ?></span><?php } ?>
                    </div>
                </article>
            <?php } ?>
            </div>
