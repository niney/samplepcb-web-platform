...
// 디자인: Figma 「웹 메인」(2286:1275) 의 top(2286:1435, 컴포넌트 2239:1851) 2026-09-18 — 72px 흰 바, 로고(심볼+SAMPLEPCB) ·
//   GNB(DB 메뉴, 하위메뉴 있으면 ▾ + 드롭다운 2286:1436) · 우측 [로그인 검정 알약 + 회원가입 회색 알약] + 아이콘 3개(견적관리·장바구니·마이페이지).
//   피그마 메뉴 문구(개발·PCB·전자 부품·PCBA·회사소개▾·블로그)는 예시 — 실제 항목은 관리자 메뉴설정(g5_menu). 반응형: <1024px 햄버거 토글.
